...
CREATE TABLE `farming_record` (
  ...
  `farmer_id` BIGINT NOT NULL COMMENT '农户ID (外键 sys_user.id)',
  ...
  `pesticide_name` VARCHAR(100) DEFAULT NULL COMMENT '用药名称 (用药记录必填)',
  `safety_interval_days` INT DEFAULT NULL COMMENT '安全间隔天数 (用药记录必填)',
